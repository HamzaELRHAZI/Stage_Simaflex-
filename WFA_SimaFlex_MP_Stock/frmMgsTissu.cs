...
{
    public partial class frmMgsTissu : Form
    {
        ...
        public ModelStockContainer thisContainer; // déclaration du model container 
        public frmMgsTissu()
        {
            InitializeComponent();
            // Instantiate the container
            thisContainer = new ModelStockContainer();
        }

        private void frmMgsTissu_Load(object sender, EventArgs e)
        {
            // désactiver le controlbox de windows applications
            ...
            while (dr.Read())
            {
                dgvMgsTissu.Rows.Add(dr[0], dr[1], dr[2], dr[3], dr[4], dr[5], dr[6]);
            }
            dr.Close();
            cnx.Close();
            ...
            cnx.Open();
            SqlCommand cmd4 = new SqlCommand("  select distinct  ArticlesSet.IdArticles  From ArticlesSet, CatégoriesSet Where ArticlesSet.Catégories_IdCatégories=CatégoriesSet.IdCatégories  And CatégoriesSet.IdCatégories= 3;", cnx);
            SqlDataReader dr4 = cmd4.ExecuteReader();
            while (dr4.Read())
            {
                cbxId.Items.Add(dr4[0]);
            }
            dr4.Close();
            cnx.Close();
            ...
            cnx.Open();
            SqlCommand cmd5 = new SqlCommand("  select distinct  Sous_CatégoriesSet.Type_Sous_Catégorie from CatégoriesSet, Sous_CatégoriesSet Where Sous_CatégoriesSet.Catégories_IdCatégories= CatégoriesSet.IdCatégories AND CatégoriesSet.IdCatégories=3;", cnx);
            SqlDataReader dr5 = cmd5.ExecuteReader();
            while (dr5.Read())
            {
                cbxSortieCatégorie.Items.Add(dr5[0]);
            }
            dr5.Close();
            cnx.Close();
            ...
            cnx.Open();
            SqlCommand cmd6 = new SqlCommand("  select distinct  ArticlesSet.Couleur  From ArticlesSet, CatégoriesSet Where ArticlesSet.Catégories_IdCatégories=CatégoriesSet.IdCatégories  And CatégoriesSet.IdCatégories= 3;", cnx);
            SqlDataReader dr6 = cmd6.ExecuteReader();
            while (dr6.Read())
            {
                cbxSortieCouleur.Items.Add(dr6[0]);
            }
            dr6.Close();
            cnx.Close();
            ...
            cnx.Open();
            SqlCommand cmd7 = new SqlCommand("  select distinct  ArticlesSet.Référence  From ArticlesSet, CatégoriesSet Where ArticlesSet.Catégories_IdCatégories=CatégoriesSet.IdCatégories  And CatégoriesSet.IdCatégories= 3;", cnx);
            SqlDataReader dr7 = cmd3.ExecuteReader();
            while (dr7.Read())
            {
                cbxSortieRéférence.Items.Add(dr7[0]);
            }
            dr7.Close();
            cnx.Close();
        ...
        private void sousCatégoriesBindingSource_CurrentChanged(object sender, EventArgs e)
        {
        ...
        private void dgvMgsTissu_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void btnEntréeOk_Click(object sender, EventArgs e)
        {
            cbxCatégorie.Text = "";
            cbxCouleur.Text = "";
            cbxRéférence.Text = "";
